...
export default function FarmhouseSection() {
  return (
    <FadeInSection>
      ...
      {/* Left Side - Content */}
      <div className="flex-1 flex flex-col gap-[35px] items-start justify-center min-h-0 min-w-0 overflow-hidden pb-[15px] pt-0.5">
        <div className="flex flex-col gap-5 items-start">
          <h2 className="font-oswald font-bold text-[45px] leading-14.75 text-[#333] capitalize w-[590px] whitespace-pre-wrap">
